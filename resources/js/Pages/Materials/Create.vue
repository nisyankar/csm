<template>
  <AppLayout
    title="Yeni Malzeme - SPT İnşaat Puantaj Sistemi"
    :full-width="true"
  >
    <!-- Full-width header -->
          ...
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  <h1 class="text-2xl lg:text-3xl font-bold text-white">Yeni Malzeme Ekle</h1>
                  <p class="text-purple-100 text-sm mt-1">Sisteme yeni malzeme tanımlayın</p>
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center space-x-2 py-2">
              <ol class="flex items-center space-x-2">
                ...
                <li class="flex items-center">
                  ...
                  <Link :href="route('materials.index')" class="text-purple-100 hover:text-white text-xs transition-colors">
                    Malzemeler
                  </Link>
                </li>
                <li class="flex items-center">
                  ...
                  <span class="text-xs font-medium text-white">Yeni Malzeme</span>
                </li>
              </ol>
            </div>
          </div>
      ...
      <div class="max-w-4xl mx-auto">
        <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  class="block w-full px-4 py-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="block w-full px-4 py-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors font-mono"
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    min="0"
                    required
                    class="block w-full pl-8 pr-4 py-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors"
                    placeholder="0.00"
                  />
                </div>
          ...
          <div class="flex items-center justify-end space-x-4 pt-6">
            <Link
              :href="route('materials.index')"
              class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors"
            >
              İptal
            </Link>
            <button
              type="submit"
              :disabled="processing"
              class="inline-flex items-center px-6 py-3 border border-transparent rounded-lg text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
