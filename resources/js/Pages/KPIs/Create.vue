<template>
  <AppLayout title="Yeni KPI Tanımı" :full-width="true">
          ...
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div class="flex-1 min-w-0">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  <h1 class="text-2xl lg:text-3xl font-bold text-white">Yeni KPI Tanımı</h1>
                  <p class="text-teal-100 text-sm mt-1">Yeni performans göstergesi oluşturun</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center space-x-2 py-2">
              <ol class="flex items-center space-x-2">
                ...
                <li class="flex items-center">
                  ...
                  <span class="text-white font-medium text-sm">Yeni KPI</span>
                </li>
              </ol>
            </div>
          </div>
      ...
      <form @submit.prevent="submit" class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200/80 overflow-hidden">
          ...
          <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Performans göstergesi bilgilerini girin</p>
          </div>
          ...
          <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
            ...
            >
              <span v-if="!form.processing">Kaydet</span>
