<template>
  <AppLayout title="Metraj Düzenleme" :full-width="true">
    <!-- Full-width header -->
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-white">Metraj Düzenleme</h1>
                <p class="text-emerald-100 text-sm mt-1">Metraj kaydını güncelleyin</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="flex items-center space-x-2 py-2">
              <ol class="flex items-center space-x-2">
                ...
                <li class="flex items-center">
                  ...
                  <span class="text-white font-medium text-sm">Düzenleme</span>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div class="text-xs text-gray-500 mb-2 p-2 bg-yellow-50 border border-yellow-200 rounded">
                  Floor ID: {{ form.project_floor_id }} | Unit ID: {{ form.project_unit_id }} | Options: {{ unitOptions.length }}
                </div>
                <select
...
const form = useForm({
  project_id: props.quantity.project_id,
  work_item_id: props.quantity.work_item_id,
  project_structure_id: props.quantity.project_structure_id,
  project_floor_id: props.quantity.project_floor_id,
  project_unit_id: props.quantity.project_unit_id,
  planned_quantity: props.quantity.planned_quantity,
  completed_quantity: props.quantity.completed_quantity,
  unit: props.quantity.unit,
  measurement_date: props.quantity.measurement_date,
  measurement_method: props.quantity.measurement_method || '',
  notes: props.quantity.notes || ''
})
...
const submit = () => {
  form.put(route('quantities.update', props.quantity.id), {
    onSuccess: () => {
