          ...
          <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">
                    Ruhsat Numarası <span class="text-red-500">*</span>
                  </label>
                  <input
...
const form = useForm({
  ...
  application_date: props.permit.application_date?.substring(0, 10) || '',
  approval_date: props.permit.approval_date?.substring(0, 10) || '',
  expiry_date: props.permit.expiry_date?.substring(0, 10) || '',
