<template>
  <AppLayout title="Yeni Finansal İşlem" :full-width="true">
    <!-- Full-width header -->
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-white">Yeni Finansal İşlem</h1>
                <p class="text-emerald-100 text-sm mt-1">Gelir veya gider kaydı oluşturun</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="flex items-center space-x-2 py-2">
              <ol class="flex items-center space-x-2">
                ...
                <li class="flex items-center">
                  ...
                  <span class="text-white font-medium text-sm">Yeni İşlem</span>
                </li>
              </ol>
            </div>
          </div>
