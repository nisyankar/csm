<template>
  <AppLayout title="Yeni Depo" :full-width="true">
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-white">Yeni Depo Kaydı</h1>
                <p class="text-cyan-100 text-sm mt-1">Depo bilgilerini girin</p>
              </div>
            </div>
          </div>
        </div>
