<template>
  <AppLayout title="Yeni Denetim" :full-width="true">
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-white">Yeni Denetim</h1>
                <p class="text-purple-100 text-sm mt-1">Denetim kaydı oluşturun</p>
              </div>
            </div>
          </div>
        </div>
