<template>
  <AppLayout title="Yeni Stok Hareketi" :full-width="true">
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-white">Yeni Stok Hareketi</h1>
                <p class="text-emerald-100 text-sm mt-1">Stok giriş/çıkış kaydı oluşturun</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p v-if="selectedMaterial && form.movement_type === 'out'" class="text-sm text-gray-500 mt-1">
                  Mevcut stok: {{ selectedMaterial.current_stock }} {{ selectedMaterial.unit }}
                </p>
              </div>
...
function onMaterialChange() {
  selectedMaterial.value = props.materials.find(m => m.id == form.material_id)
}
