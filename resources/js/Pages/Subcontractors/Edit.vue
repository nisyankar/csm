...
const form = useForm({
    ...
    trade_title: props.subcontractor.trade_title || '',
    tax_office: props.subcontractor.tax_office || '',
    tax_number: props.subcontractor.tax_number || '',
    address: props.subcontractor.address || '',
    city: props.subcontractor.city || '',
    district: props.subcontractor.district || '',
    postal_code: props.subcontractor.postal_code || '',
    phone: props.subcontractor.phone || '',
    fax: props.subcontractor.fax || '',
    email: props.subcontractor.email || '',
    website: props.subcontractor.website || '',
    authorized_person: props.subcontractor.authorized_person || '',
    authorized_phone: props.subcontractor.authorized_phone || '',
    authorized_email: props.subcontractor.authorized_email || '',
    authorized_title: props.subcontractor.authorized_title || '',
    bank_name: props.subcontractor.bank_name || '',
    branch_name: props.subcontractor.branch_name || '',
    branch_code: props.subcontractor.branch_code || '',
    account_number: props.subcontractor.account_number || '',
    iban: props.subcontractor.iban || '',
    category_id: props.subcontractor.category_id || '',
    status: props.subcontractor.status || 'active',
    is_approved: props.subcontractor.is_approved || false,
    notes: props.subcontractor.notes || '',
    tags: props.subcontractor.tags || [],
})

const submit = () => {
    form.patch(route('subcontractors.update', props.subcontractor.id))
}
</script>
            ...
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 shadow-lg">
                <div class="px-4 sm:px-6 lg:px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-white">Taşeron Düzenle</h1>
                            <p class="mt-2 text-purple-100">{{ subcontractor.company_name }} - Bilgileri güncelle</p>
                        </div>
                        <Link
