...
class TimesheetController extends Controller
{
    ...
    {
        $query = Timesheet::with(['employee', 'project', 'shift']);
    ...
    public function bulkApprove(Request $request)
    {
        ...
        $updated = Timesheet::whereIn('id', $validated['timesheet_ids'])
            ->unlocked()
            ->update([
                'is_approved' => true,
    ...
    public function bulkEntry(Request $request)
    {
        ...
        if ($request->filled('project_id') && $request->filled('month')) {
            ...
            $existingTimesheets = Timesheet::with('shift')
     ...
     * Tekil puantaj onayı
     */
    public function approve(Timesheet $timesheet, TimesheetApprovalService $approvalService)
    {
        try {
     ...
     * Puantajı reddet
     */
    public function reject(Request $request, Timesheet $timesheet, TimesheetApprovalService $approvalService)
    {
        $validated = $request->validate([
     ...
     */
    public function hrOverride(Request $request, Timesheet $timesheet, TimesheetApprovalService $approvalService)
    {
        $validated = $request->validate([
